...
export const Footer = () => {
  return (
    <footer className="bg-neutral-950 text-white border-t border-neutral-900 relative overflow-hidden">
      ...
      <Container>
        {/* Optimized Padding: pt-10 pb-6 for a sleek, thin profile */}
        <div className="flex flex-col pt-10 pb-6">
          ...
          <div className="grid lg:grid-cols-12 gap-8 mb-10">
            ...
            <div className="lg:col-span-5 flex flex-col items-start gap-3">
              ...
              <p className="text-neutral-500 max-w-sm leading-relaxed text-xs font-light">
            ...
            <div className="lg:col-span-4 pt-1">
              ...
              <p className="text-neutral-400 text-xs leading-relaxed font-light">
                Mizoram Startup Mission, Treasury Square<br />
                Aizawl, Mizoram, India — 796001
              </p>
            </div>

            {/* 3. Navigation */}
            <div className="lg:col-span-3 lg:text-right pt-1">
              <h3 className="font-mono text-[9px] uppercase tracking-[0.2em] text-[#a80607] mb-3 font-bold">
                Firm
              </h3>
              <ul className="space-y-2 text-xs font-medium">
                <li>
                  <Link href="/about" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/thesis" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    Investment Thesis
                  </Link>
                </li>
                <li>
                  <Link href="/team" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    Team
                  </Link>
                </li>
                <li>
                  <Link href="/careers" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link href="/thesis#faq" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-neutral-500 hover:text-white transition-colors duration-200">
                    Contact
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
              ...
              <div className="flex gap-5">
                <Link href="#" className="text-[10px] text-neutral-600 hover:text-[#a80607] transition-colors uppercase tracking-widest">
                  Legal
                </Link>
                <Link href="#" className="text-[10px] text-neutral-600 hover:text-[#a80607] transition-colors uppercase tracking-widest">
                  Privacy
            ...
            {/* Social Icons including X (Twitter) */}
            <div className="flex gap-2.5">
              ...
              {/* Email */}
              <a href="mailto:partners@redvanda.com" className="group w-7 h-7 flex items-center justify-center rounded-full bg-white/5 border border-white/5 hover:bg-[#a80607] hover:border-[#a80607] transition-all duration-300">
